...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:40px_40px]">
      <div className="flex h-full justify-center">
        ...
        >
          ...
          <div className="relative flex-grow w-full">
            <div className="absolute bottom-0 left-0 right-0 flex justify-center items-end pb-[32px]">
